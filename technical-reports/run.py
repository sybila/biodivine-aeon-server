...
if __name__ == "__main__":
	...
	OUT_DIR = os.path.basename(BENCH_DIR) + "_" + os.path.basename(SCRIPT)
	if PARALLEL > 0:
	...
	TIMES = open(OUT_DIR + "/" + os.path.basename(BENCH_DIR) + "_" + os.path.basename(SCRIPT) + "_times.csv", "w")
	TIMES.write("Benchmark, Time[s]\n")

	# Create an aggregated stats file
	AGGREGATION = open(OUT_DIR + "/" + os.path.basename(BENCH_DIR) + "_" + os.path.basename(SCRIPT) + "_aggregated.csv", "w")
